...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { description: @equipment.description, image: @equipment.image, name: @equipment.name }
    end
  ...
  test "should update equipment" do
    put :update, id: @equipment, equipment: { description: @equipment.description, image: @equipment.image, name: @equipment.name }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
